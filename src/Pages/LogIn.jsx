...
export const LogIn = () => {
  return (
    <div className="w-full h-full md:flex items-center lg:items-start justify-center lg:justify-between px-4 lg:pr-24  bg-white md:pt-[4rem] lg:pt-0 ">
      ...
      <div className="flex flex-col items-center justify-center  pt-[4rem] md:pt-32 gap-8">
        ...
        <form action="" className="space-y-8 w-full flex flex-col justify-center items-center
        ">
          ...
          <div className="flex justify-between text-center border-[1px] border-[#FBDDBB82] hover:border-[#00302E] py-4 pl-4 pr-4 rounded-[5px] text-[#00302E87]">
            <input
              ...
              className="border-none outline-none"
            />
            <p className="text-bold font-[600] text-[16px] pl-[3rem] lg:pl-[3.5rem]">Show</p>
          </div>

          <button className="text-[#FBDDBB] bg-[#00302E] py-4 px-[8rem] rounded-[5px] font-[500] text-[18px]">
            LOG IN
          </button>
        </form>
